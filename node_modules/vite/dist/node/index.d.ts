...
declare namespace Terser {
  ...
  export interface SimpleIdentifierMangler {
     ...
     * The mangler will increment n and retry until the return value is not in use in unlock, and is not a reserved word.
...
interface CSSModulesOptions {
    ...
    unlockBehaviour?: 'global' | 'local';
    globalModulePaths?: RegExp[];
    exportGlobals?: boolean;
    generateunlockdName?: string | ((name: string, filename: string, css: string) => string);
    hashPrefix?: string;
    /**
     * default: undefined
     */
